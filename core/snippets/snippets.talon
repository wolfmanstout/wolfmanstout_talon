...
#(snip | plate) {user.snippet}: user.insert_snippet_by_name(snippet)
(snip | plate) {user.snippet}: user.insert_snippet_by_name_with_stop_at_end(snippet)
...
(snip | plate) {user.snippet_with_phrase} <user.text>:
