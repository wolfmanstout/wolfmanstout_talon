...
def _cleanup_prompt(prior_context: str, utterance_text: str) -> str:
    return (
        ...
        "(2) insert a clearly needed comma, but no other unspoken punctuation; or (3) correct a "
        "wrong homophone (identical pronunciation). Outside those replacements, never add, "
        "delete, reorder, or alter words; do not proofread. Output corrected <utterance> only, or "
        "NOCHANGE if unchanged.\n\n"
        "FIX examples:\n"
        ...
        "'The exclamation mark is large'; 'The colon absorbs water'; "
        "'A semicolon joins clauses'; 'Mark asked a question'; 'Are you ready'; "
