...
project [run] shell: user.emacs("project-shell")
project [run] eshell: user.emacs("project-eshell")
project search: user.emacs("project-search")
project vc dir: user.emacs("project-vc-dir")
project compile [project]: user.emacs("project-compile")
project [run] shell command: user.emacs("project-shell-command")
