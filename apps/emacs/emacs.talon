...
<number> (through | until) [select]: user.mark_lines(number_1, -1)
<number> (through | until) <number> [select]: user.mark_lines(number_1, number_2)
<number> (through | until) short [select]: user.mark_lines(number_1, -1, 1)
<number> (through | until) <number> short [select]: user.mark_lines(number_1, number_2, 1)
<number> (through | until) copy here: user.use_lines(number_1, -1, "alt-w", "ctrl-y")
<number> (through | until) <number> copy here: user.use_lines(number_1, number_2, "alt-w", "ctrl-y")
<number> (through | until) short copy here: user.use_lines(number_1, -1, "alt-w", "ctrl-y", 1)
<number> (through | until) <number> short copy here: user.use_lines(number_1, number_2, "alt-w", "ctrl-y", 1)
<number> (through | until) move here: user.use_lines(number_1, -1, "ctrl-w", "ctrl-y")
<number> (through | until) <number> move here: user.use_lines(number_1, number_2, "ctrl-w", "ctrl-y")
<number> (through | until) short move here: user.use_lines(number_1, -1, "ctrl-w", "ctrl-y", 1)
<number> (through | until) <number> short move here: user.use_lines(number_1, number_2, "ctrl-w", "ctrl-y", 1)
other <number> (through | until) copy here: user.use_lines(number_1, -1, "alt-w", "ctrl-y", 0, 1)
other <number> (through | until) <number> copy here: user.use_lines(number_1, number_2, "alt-w", "ctrl-y", 0, 1)
other <number> (through | until) short copy here: user.use_lines(number_1, -1, "alt-w", "ctrl-y", 1, 1)
other <number> (through | until) <number> short copy here: user.use_lines(number_1, number_2, "alt-w", "ctrl-y", 1, 1)
other <number> (through | until) move here: user.use_lines(number_1, -1, "ctrl-w", "ctrl-y", 0, 1)
other <number> (through | until) <number> move here: user.use_lines(number_1, number_2, "ctrl-w", "ctrl-y", 0, 1)
other <number> (through | until) short move here: user.use_lines(number_1, -1, "ctrl-w", "ctrl-y", 1, 1)
other <number> (through | until) <number> short move here: user.use_lines(number_1, number_2, "ctrl-w", "ctrl-y", 1, 1)
